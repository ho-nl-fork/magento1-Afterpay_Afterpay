 ...
 */
 ...
 class Afterpay_Afterpay_Block_PaymentFee_Checkout_Fee extends Mage_Checkout_Block_Total_Default
{
    protected $_template = 'Afterpay/Afterpay/paymentFee/checkout/fee.phtml';

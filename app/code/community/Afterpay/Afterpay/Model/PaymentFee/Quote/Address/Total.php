 ...
 */
 ...
 class Afterpay_Afterpay_Model_PaymentFee_Quote_Address_Total extends Mage_Sales_Model_Quote_Address_Total_Abstract
{
    ...
    {            
        ...
        if (
            ...
            $value = $address->getBasePaymentFee() + $address->getBasePaymentFeeTax();

 ...
 */
 ...
 class Afterpay_Afterpay_Block_PaymentFee_Order_Creditmemo_Totals_Paymentfee extends Mage_Core_Block_Abstract
{
    public function initTotals()
    {
        ...
        if ($this->_creditmemo->getinvoice()) {
            ...
            $paymentFee->setValue($this->_creditmemo->getInvoice()->getPaymentFee() - $this->_creditmemo->getOrder()->getPaymentFeeRefunded() + ($this->_creditmemo->getInvoice()->getPaymentFeeTax() - $this->_creditmemo->getOrder()->getPaymentFeeTaxRefunded()));
